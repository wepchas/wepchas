...
export default function Privacy() {
  return (
    <div className="p-3">
      ...
      <p>
        Pchas Co Also Known as We Pchas values it's users privacy and security,
        We assure our games are already quality checked and published only on
        valid stores.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Stack Pattern unless
      ...
      <p>
        ...
        but not limited to None. The information that we request will be
      ...
      <p>This policy is effective as of 2021-11-16</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about our Privacy Policy, do
        not hesitate to contact us at we.pchas@gmail.com.
      </p>{" "}
    </div>
  );
}
